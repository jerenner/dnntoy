...
// ********************************************************************
//
// Copy of class: $Id: G4EmStandardPhysics_option4.cc 88877 2015-03-13 16:00:02Z gcosmo $
//
//

#include "EmMagboxPhysics.h"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(EmMagboxPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

EmMagboxPhysics::EmMagboxPhysics(G4int ver)
  : G4VPhysicsConstructor("EmMagbox"), verbose(ver)
{
...
EmMagboxPhysics::~EmMagboxPhysics()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void EmMagboxPhysics::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void EmMagboxPhysics::ConstructProcess()
{
  if(verbose > 1) {
